...
```javascript
cabs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cabs2@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cabs2@v0.2.0-umd/browser.js"></script>
```
